 ...
 * 利用动画实现
 */
public class MarqueeView3 extends LinearLayout {
	...
	public MarqueeView3(Context context) {
		super(context);
		init(context);
	}

	public MarqueeView3(Context context, AttributeSet attrs) {
		super(context, attrs);

		init(context);
	}

	public MarqueeView3(Context context, AttributeSet attrs, int defStyle) {
